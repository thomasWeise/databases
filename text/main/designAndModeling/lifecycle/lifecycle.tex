...
We start with the conceptual schema:
...
Finally, the logical model, i.e., the perspective of the users on the data, is mapped to a physical schema.
The physical schema is the internal representation of the data as provided by the \dbms.
The logical schema defines \emph{how} the data is accessed.
The physical schema defines how the access is made \emph{efficient} and can contain information about the physical layout of the data as well as the use of indexes and other performance tweaks.
