...
At first glance, one may think that \inQuotes{Relations = Tables} in a \db.
...
In a response, \citeauthor{C1985IYDRR} defined thirteen rules that govern a relational~\pgls{dbms}~\cite{C1985IYDRR,C1986AESFDBMSTACTBR}.
