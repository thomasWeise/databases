...
\listingSQLandOutput{CD_tables}{CD_tables.sql}{%
...
\listingSQLandOutput{CD_insert_and_select}{CD_insert_and_select.sql}{%
...
\listingSQLandOutput{CD_insert_error}{CD_insert_error.sql}{%
