...
\listingSQLandOutput{ST_tables}{ST_tables.sql}{%
...
\listingSQLandOutput{ST_insert_and_select}{ST_insert_and_select.sql}{%
...
\listingSQLandOutput{ST_insert_error_1}{ST_insert_error_1.sql}{%
...
\listingSQLandOutput{ST_insert_error_2}{ST_insert_error_2.sql}{%
