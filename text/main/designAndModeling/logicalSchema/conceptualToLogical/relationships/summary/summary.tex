...
We found that each of these types can be implemented in a relational \dbms.
With \emph{implemented}, we refer to the cardinality and modality of the relationship ends.
...
One may also use more complex tools for that, like Stored Procedures and Transactions, which we do not discuss at this stage.
