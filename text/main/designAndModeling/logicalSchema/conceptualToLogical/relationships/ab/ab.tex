...
\caption{Examples of the \crowsFoot{A}{O1}{B}{O1} relationship pattern from back in \cref{sec:conceptual:relationshipCardinalities}.}%
\label{fig:rm:ab}%
\end{figure}%
%
...
%
\gitExecPath{\databasesCodeRepo}{conceptualToRelational}{../_scripts_/db_table_to_latex_table.sh relationships a aid;x}{cdtrmTableAO}%
\gitExecPath{\databasesCodeRepo}{conceptualToRelational}{../_scripts_/db_table_to_latex_table.sh relationships b bid;y}{cdtrmTableBO}%
\gitExecPath{\databasesCodeRepo}{conceptualToRelational}{../_scripts_/db_table_to_latex_table.sh relationships relate_a_and_b fkaid;fkbid}{cdtrmTableRAB}%
%
\begin{figure}%
\centering%
\floatSep%
\centering\input{\cdtrmTableAO}%
\floatSep%
\centering\input{\cdtrmTableBO}%
\floatSep%
\centering\input{\cdtrmTableRAB}%
\floatSep%
...
%
\gitExecPath{\databasesCodeRepo}{conceptualToRelational}{../_scripts_/db_table_to_latex_table.sh relationships a aid;fkbid;x}{cdtrmTableAT}%
\gitExecPath{\databasesCodeRepo}{conceptualToRelational}{../_scripts_/db_table_to_latex_table.sh relationships b bid;y}{cdtrmTableBT}%
%
\begin{figure}%
\centering%
\floatSep%
