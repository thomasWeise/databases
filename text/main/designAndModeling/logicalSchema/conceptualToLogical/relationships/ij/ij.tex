...
\caption{Examples of the \crowsFoot{I}{M1}{J}{M1} relationship pattern from back in \dref{sec:conceptual:relationshipCardinalities}.}%
\label{fig:rm:ij}%
\end{figure}%
%
\gitLoadSQL{IJ_tables}{}{conceptualToRelational/IJ_tables.sql}%
\listingSQL{IJ_tables}{%
...
We discussed a few examples of this relationship pattern from back in \dref{sec:conceptual:relationshipCardinalities}.
