...
\listingSQLandOutput{OP_tables}{OP_tables.sql}{%
...
\listingSQLandOutput{OP_insert_and_select}{OP_insert_and_select.sql}{%
...
\listingSQLandOutput{OP_insert_error}{OP_insert_error.sql}{%
