...
\listingSQLandOutput{GH_tables}{GH_tables.sql}{%
...
\listingSQLandOutput{GH_insert_and_select}{GH_insert_and_select.sql}{%
...
\listingSQLandOutput{GH_insert_error_1}{GH_insert_error_1.sql}{%
...
\listingSQLandOutput{GH_insert_error_2}{GH_insert_error_2.sql}{%
...
\listingSQLandOutput{GH_insert_error_3}{GH_insert_error_3.sql}{%
...
\listingSQLandOutput{GH_insert_error_4}{GH_insert_error_4.sql}{%
...
\listingSQLandOutput{GH_insert_error_5}{GH_insert_error_5.sql}{%
