...
\caption{An example of the \crowsFoot{G}{O1}{H}{MM} relationship pattern from back in \cref{sec:conceptual:relationshipCardinalities}.}%
\label{fig:rm:gh}%
\end{figure}%
%
...
%
\gitExecPath{\databasesCodeRepo}{conceptualToRelational}{../_scripts_/db_table_to_latex_table.sh relationships g gid;fkhid;x}{cdtrmTableG}%
\gitExecPath{\databasesCodeRepo}{conceptualToRelational}{../_scripts_/db_table_to_latex_table.sh relationships h hid;fkgid;y}{cdtrmTableH}%
%
\begin{figure}%
\centering%
\floatSep%
...
An example of the \crowsFoot{G}{O1}{H}{MM} relationship pattern is given back in \cref{sec:conceptual:relationshipCardinalities}:
