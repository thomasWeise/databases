...
\end{itemize}%
%
Now, in the conceptual model illustrated as \cref{fig:erdPerson2B} in the previous section, there was one derived attribute, namely~\emph{Age}.
...
%
\gitExecSQLraw{teachingManagement:logical:person_database_2:cleanup.sql}{}{teachingManagement/logical/person_database_2}{cleanup.sql}{}{}{}%
