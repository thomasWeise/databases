...
%
\subfloat[][%
A reproduction of \cref{fig:erdPerson2} from back in \cref{sec:conceptual:relationships}, which was created using \yEd.%
...
\end{figure}%
%
Relationships in conceptual models may have attributes.
...
to \cref{fig:erdPerson2} from back in \cref{sec:conceptual:relationships}.
...
In other words, we follow the pattern \crowsFoot{O}{OM}{P}{OM} discussed in \cref{sec:rm:op}.
