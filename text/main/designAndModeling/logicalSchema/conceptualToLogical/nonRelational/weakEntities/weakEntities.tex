...
%
\subfloat[][%
A reproduction of \cref{fig:erdPerson4} from back in \cref{sec:conceptual:relationshipCardinalities}, which was created using \yEd.%
...
Then we use basically the same code as in \cref{lst:MN_insert_and_select} from back in \cref{sec:rm:mn} to fill the tables~\sqlil{person} and \sqlil{personal_id}.
