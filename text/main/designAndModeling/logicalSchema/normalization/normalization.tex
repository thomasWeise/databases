...
In order to achieve this, several guidelines and best practices can be followed.
Some of the most important of these concern \emph{normalization}~\cite{D2003AITDS,EN2015FODS}.
...
It does so usually at the trade-off of data retrieval speed:
...
There exist several \glsFull{NF}.
Out of these, we shall here consider the \glsFull{1NF}, the \glsFull{2NF}, and the \glsFull{3NF}.
