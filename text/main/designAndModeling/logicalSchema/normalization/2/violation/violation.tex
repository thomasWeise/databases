...
%
\gitSQLAndOutput{\databasesCodeRepo}{normalization/2nf/violation}{select_buildings_1.sql}{violation}{}{}{postgres.sh}{normalization:2nf:violation:select_buildings_1}{%
Selecting a list of all buildings from the \db.}%
%
...
Deleting the two offices 904a and 904b of Building~53 from our \db.}%
%
\gitSQLAndOutput{\databasesCodeRepo}{normalization/2nf/violation}{select_buildings_2.sql}{violation}{}{}{postgres.sh}{normalization:2nf:violation:select_buildings_2}{%
Deleting the rooms in Building~53 means that also all data about Building~53 has disappeared.}%
%
...
We want to see all buildings in South Campus~2. %
Due to some inconsistent spelling~(South Campus~II vs.\ South Campus~2), the first query misses some buildings. %
We then run a modified query, which gives us all the buildings. %
...
We now run the same query giving us the list of buildings again.
