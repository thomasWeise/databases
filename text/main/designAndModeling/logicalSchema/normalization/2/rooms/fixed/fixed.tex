...
\listingSQLandOutput{2nf:rooms:fixed:delete}{delete.sql}{%
...
\listingSQLandOutput{2nf:rooms:fixed:update}{update.sql}{%
...
\listingSQLandOutput{2nf:rooms:fixed:update2}{update2.sql}{%
