...
%
\gitSQL{\databasesCodeRepo}{normalization/2nf/rooms/violation/generated_sql/03_public_building_room_table_5071.sql}{2nf:rooms:violation:03_public_building_room_table_5071}{The generated \sql\ code for creating the table \sqlil{building_room} that violates the \pgls{2NF} based on \cref{fig:roomsViolation2nf:model}.}%
...
%
\gitSQL{\databasesCodeRepo}{normalization/2nf/rooms/violation/insert.sql}{2nf:rooms:violation:insert}{%
...
%
\gitSQLAndOutput{\databasesCodeRepo}{normalization/2nf/rooms/violation}{delete.sql}{violation}{}{}{postgres.sh}{2nf:rooms:violation:delete}{%
...
%
\gitSQLAndOutput{\databasesCodeRepo}{normalization/2nf/rooms/violation}{update.sql}{violation}{}{}{postgres.sh}{2nf:rooms:violation:update}{%
...
%
\gitSQLAndOutput{\databasesCodeRepo}{normalization/2nf/rooms/violation}{update2.sql}{violation}{}{}{postgres.sh}{2nf:rooms:violation:update2}{%
