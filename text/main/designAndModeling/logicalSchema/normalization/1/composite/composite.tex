...
%
\gitSQL{\databasesCodeRepo}{normalization/1nf/anomaly_composite/insert.sql}{1nf:anomaly_composite:insert}{%
...
%
\gitSQLAndOutput{\databasesCodeRepo}{normalization/1nf/anomaly_composite}{select.sql}{anomalies}{}{}{postgres.sh}{1nf:anomaly_composite:select}{%
...
%
\gitSQL{\databasesCodeRepo}{normalization/1nf/fixed_composite/insert.sql}{1nf:fixed_composite:insert}{%
...
%
\gitSQLAndOutput{\databasesCodeRepo}{normalization/1nf/fixed_composite}{select.sql}{fixed}{}{}{postgres.sh}{1nf:fixed_composite:select}{%
