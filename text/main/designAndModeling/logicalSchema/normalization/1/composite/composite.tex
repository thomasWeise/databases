\hsection{Violation:~The Use of Composite Attributes}%
\FloatBarrier%
%
\begin{figure}%
\centering%
\includegraphics[width=0.6\linewidth]{\currentDir/anomalyComposite}%
...
\end{figure}%
%
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/anomaly_composite/generated_sql 01_anomalies_database_2001.sql}%
%
\gitSQL{\databasesCodeRepo}{normalization/1nf/anomaly_composite/generated_sql/03_public_address_table_5071.sql}{1nf:anomaly_composite:03_public_address_table_5071}{The generated \sql\ code for creating the \sqlil{address} table that violates the \pgls{1NF} based on \cref{fig:anomalyComposite}.}%
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/anomaly_composite/generated_sql 03_public_address_table_5071.sql anomalies}%
%
\gitSQL{\databasesCodeRepo}{normalization/1nf/anomaly_composite/generated_sql/04_public_student_table_5075.sql}{1nf:anomaly_composite:04_public_student_table_5075}{The generated \sql\ code for creating the \sqlil{student} table based on \cref{fig:anomalyComposite}.}%
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/anomaly_composite/generated_sql 04_public_student_table_5075.sql anomalies}%
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/anomaly_composite/generated_sql 05_public_student_student_address_fk_constraint_5080.sql anomalies}%
%
\gitSQL{\databasesCodeRepo}{normalization/1nf/anomaly_composite/insert.sql}{normalization:1nf:anomaly_composite:insert}{%
...
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/anomaly_composite insert.sql anomalies}%
%
\gitSQLAndOutput{\databasesCodeRepo}{normalization/1nf/anomaly_composite}{select.sql}{anomalies}{}{}{postgres.sh}{normalization:1nf:anomaly_composite:select}{%
Trying to find all the students with an address in China, which is hard, because table \sqlil{address} violates the \pgls{1NF}.}%
%
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/anomaly_composite cleanup.sql}%
%
...
We then insert some data into them \db\ \cref{lst:normalization:1nf:anomaly_composite:insert}.
...
In \cref{lst:normalization:1nf:anomaly_composite:select}, we combine the tables~\sqlil{student} and \sqlil{address} by using an \sqlilIdx{INNER JOIN} statement.
...
\begin{figure}%
\centering%
\includegraphics[width=0.6\linewidth]{\currentDir/fixedComposite}%
...
\end{figure}%
%
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/fixed_composite/generated_sql 01_fixed_database_2001.sql}%
%
\gitSQL{\databasesCodeRepo}{normalization/1nf/fixed_composite/generated_sql/03_public_address_table_5071.sql}{1nf:fixed_composite:03_public_address_table_5071}{The generated \sql\ code for creating the \sqlil{address} table based on \cref{fig:fixedComposite}, which no longer violates the \pgls{1NF}.}%
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/fixed_composite/generated_sql 03_public_address_table_5071.sql fixed}%
%
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/fixed_composite/generated_sql 04_public_student_table_5079.sql fixed}%
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/fixed_composite/generated_sql 05_public_student_student_address_fk_constraint_5084.sql fixed}%
%
\gitSQL{\databasesCodeRepo}{normalization/1nf/fixed_composite/insert.sql}{normalization:1nf:fixed_composite:insert}{%
...
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/fixed_composite insert.sql fixed}%
%
\gitSQLAndOutput{\databasesCodeRepo}{normalization/1nf/fixed_composite}{select.sql}{fixed}{}{}{postgres.sh}{normalization:1nf:fixed_composite:select}{%
...
%
\gitExec{\databasesCodeRepo}{.}{_scripts_/postgres.sh normalization/1nf/fixed_composite cleanup.sql}%
