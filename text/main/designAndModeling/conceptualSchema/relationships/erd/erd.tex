...
This could be \inQuotes{Mobile Phone~(China),} \inQuotes{Mobile Phone~(Intl),} \inQuotes{ID~(中华人民共和国居民身份证),} \inQuotes{Passport~(护照),} \inQuotes{Work Permit~(中华人民共和国外国人工作许可证),} \inQuotes{X1-Visa,} \inQuotes{X2-Visa,} \inQuotes{Z-Visa,} \inQuotes{Email Address,} \inQuotes{WeChat User Name,} whatever.
