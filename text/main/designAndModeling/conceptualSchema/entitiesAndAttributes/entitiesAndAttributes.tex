...
%
\subfloat[][%
We change the entity name to \inQuotes{Student} and press \keys{\return}.%
...
We change the entity name to \inQuotes{Student} and press \keys{\return} in \cref{fig:yedErdEntitiesA05changeNameToStudent}.
