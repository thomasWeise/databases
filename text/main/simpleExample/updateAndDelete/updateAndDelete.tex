...
\listingSQLandOutput{factory:update_table_product}{update_table_product.sql}{%
...
\listingSQLandOutput{factory:delete_from_table_product}{delete_from_table_product.sql}{%
