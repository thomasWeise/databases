...
The corresponding option is most likely hidden behind double-angle button near the bottom on the pane on the left side.%
...
%
\subfloat[][%
Click on the \menu{Tabular Control} control.%
...
We unselect the pencil symbol in the bottom bar.%
...
We want to edit the form and thus click on the pencil symbol in the bottom bar.%
...
After releasing it, we again click on the pencil symbol to leave the design view.%
