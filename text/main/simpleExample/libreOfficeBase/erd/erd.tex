...
\end{figure}%
%
An important tool in \db\ design are \glsreset{ERD}\pglspl{ERD}.
...
In the domain of \pglspl{db}, the objects could be tables and the relationships could be foreign key relationships.
