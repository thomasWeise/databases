...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport01main}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport03wizardDataSource}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport04wizardDataFields}}}%
%
\floatRowSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport05wizardDataFieldsChosen}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport06wizardLabels}}}%
%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport07wizardLabelsChosen}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport08wizardGrouping}}}%
%
\floatRowSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport09wizardGroupingByCustomer}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport10wizardSorting}}}%
%
\floatRowSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport11wizardSortingFields}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport12wizardLayout}}}%
%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport13wizardPortrait}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport14wizardCreate}}}%
%
\floatRowSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport15wizardCreateSale}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport16wizardCreateModifyLayout}}}%
%
\floatRowSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport17created}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport18customerLabelRemoved}}}%
%
%
\caption{Creating and executing \db\ reports in \libreofficeBase\ (Continued).}%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport19customerShrinked}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport20headerSelected}}}%
%
\floatRowSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport21headerMovedUp}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport22headerDeselected}}}%
%
\floatRowSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport23headerShrunk}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport24headerSelected}}}%
%
\floatRowSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport25headerMovedDown}}}%
%
\floatSep%
%
\subfloat[][%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport26save}}}%
%
\caption{Creating and executing \db\ reports in \libreofficeBase\ (Continued).}%
...
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport27saved}}}%
%
\floatSep%
%
\subfloat[][%
...
We can even export it to PDF by clicking the PDF symbol~\libreOfficePdf.%
\label{fig:factoryLibreOfficeBaseReport28executed}%
]{\tightbox{\includegraphics[width=0.49\linewidth]{\currentDir/factoryLibreOfficeBaseReport28executed}}}%
%
\floatRowSep%
%
\subfloat[][%
...
To explore feature this at least a little bit, we select \menu{Reports} in the \menu{Database} pane and click on \inQuotes{Use Wizard to Create Report\dots} in the \libreofficeBase main window as shown in \cref{fig:factoryLibreOfficeBaseReport01main}.
