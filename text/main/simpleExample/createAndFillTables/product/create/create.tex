...
Fittingly, the command for creating tables is called \sqlil{CREATE TABLE}\sqlIdx{CREATE!TABLE}\sqlIdx{TABLE!CREATE}.
...
As you can see, before executing the \sqlil{CREATE TABLE}\sqlIdx{CREATE!TABLE}\sqlIdx{TABLE!CREATE} command, this query returns nothing.
