...
\listingSQLandOutput{factory:insert_into_table_product_error}{insert_into_table_product_error.sql}{%
...
\listingSQLandOutput{factory:select_from_table_product}{select_from_table_product.sql}{%
