...
We just have to remove the trailing~\sqlil{;} from the first query and write a \sqlilIdx{UNION} directly in front of the second query~\cite{PGDG:PD:CQUIE}!
The \sqlilIdx{UNION} statement effectively appends the results of the second query to the results of the first query.
