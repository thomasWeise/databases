...
\listingSQLandOutput{factory:select_customer_demand}{select_customer_demand.sql}{%
...
\listingSQLandOutput{factory:create_view_sale}{create_view_sale.sql}{%
...
\listingSQLandOutput{factory:select_from_view_sale_1}{select_from_view_sale_1.sql}{%
...
\listingSQLandOutput{factory:select_from_view_sale_2}{select_from_view_sale_2.sql}{%
Compute the per-customer and per-product sales based on the view \textil{sale}.%
}{}%
%
