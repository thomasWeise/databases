...
We start the \client\ program \psql\ with the connection \pgls{URI}~\cite{PGDG:PD}.
We connect to the \postgresql\ \server\ by providing the connection \pgls{URI} \textil{postgres://postgres:XXX@localhost}.
