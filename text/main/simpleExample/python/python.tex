...
The sessions and cursors to the \db\ are implemented as context managers~\cite{PSF2024WSCM}, which means that they will automatically be closed at the end of the \pythonilIdx{with} block.
...
Connectors similar to \psycopg\ probably exist for \pgls{Java} and \pgls{C} as well.
