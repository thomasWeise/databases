...
\pythonilIdx{LiteralString} is a type annotation for string \emph{literals}.
...
\pythonilIdx{LiteralString} is basically a special string type, a subclass of \pythonil{str}, for strings literals, i.e., strings that were written as text in \python.
...
It is enforced that each command be a string literal, i.e., of type~\pythonilIdx{LiteralString}.
