...
The object type could, e.g., be \sqlil{TABLE}\sqlIdx{DROP!TABLE}\sqlIdx{TABLE!DROP}, \sqlil{VIEW}\sqlIdx{DROP!VIEW}\sqlIdx{VIEW!DROP}, \sqlil{USER}\sqlIdx{DROP!USER}\sqlIdx{USER!DROP}, or \sqlil{DATABASE}\sqlIdx{DROP!DATABASE}\sqlIdx{DATABASE!DROP}.
