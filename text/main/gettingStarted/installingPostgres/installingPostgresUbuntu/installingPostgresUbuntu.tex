...
%
\subfloat[][%
In order to set a proper password for the \postgresql\ main user \textil{postgresql}, we need to log into \psql\ using super user privileges, but under the newly created system user \textil{postgres}. %
