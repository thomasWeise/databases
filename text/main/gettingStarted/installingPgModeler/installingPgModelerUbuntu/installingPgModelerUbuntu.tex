...
%
\subfloat[][%
Open a \bash\ \pgls{terminal} via with \ubuntuTerminal. %
Type in \bashil{sudo apt-get install pgmodeler} and hit~\keys{\enter}.%
...
%
\subfloat[][%
We get asked for the \pgls{sudo} password, type it in, and hit~\keys{\enter}.%
...
We type~\keys{Y} and hit~\keys{\enter}.%
...
%
\subfloat[][%
We now run the \pgmodeler\ by typing \bashil{pgmodeler} into the \bash\ \pgls{terminal} and hitting~\keys{\enter}.%
...
In \cref{fig:installingPgmodelerUbuntu01aptGetInstall}, we then type in \bashil{sudo apt-get install pgmodeler} and hit~\keys{\enter}.
...
So we type~\keys{Y} and hit~\keys{\enter} in \cref{fig:installingPgmodelerUbuntu04yny}.%
In \cref{fig:installingPgmodelerUbuntu05installed}, the \pgmodeler\ gets downloaded and installed.

After the installation is completed, we can run the \pgmodeler\ by typing \bashil{pgmodeler} into the \bash\ \pgls{terminal} and hitting~\keys{\enter} in \cref{fig:installingPgmodelerUbuntu06run}.
