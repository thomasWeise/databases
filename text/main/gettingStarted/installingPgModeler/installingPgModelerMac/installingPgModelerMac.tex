...
%
\item Download the \pgls{macPorts} suitable for your version of \pgls{macOS}. %
...
%
\item Execute the command \bashil{sudo port -v selfupdate}. %
It will ask you for your password, i.e., the (administrator) password for your computer. %
...
\item Open a \emph{new} \pgls{terminal} window.%
%
\item Type in \bashil{xcode-select --install}. %
...
\item Open a \emph{new} \pgls{terminal} window.%
%
\item Enter \bashil{sudo port install pgmodeler}. %
It will ask you for your password, i.e., the (administrator) password for your computer. %
Enter it an hit~\keys{\return}.%
%
\item After the installation completes, close the \pgls{terminal}.%
...
\item Open a \emph{new} \pgls{terminal} window.%
%
\item You should now be able to execute \pgmodeler\ using the command \bashil{pgmodeler}.%
%
\end{enumerate}%
%
...
What \pgls{MSYS2} offers for \microsoftWindows, \pgls{macPorts} offers for \pgls{macOS}.
