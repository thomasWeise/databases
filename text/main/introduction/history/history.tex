\hsection{History}%
%
We will now take a brief look at the history of \pglspl{db}.
...
Like IDS, it was not a \pgls{dbms} for \emph{relational \pglspl{db}}.
...
%
\quotation{C1970ARMODFLSDB}{Future users of large data banks must be protected from having to know how the data is organized in the machine (the internal representation).}%
%
...
At the same time where SEQUEL was developed, the Interactive Graphics and Retrieval System~(INGRES) group at UC~Berkeley, too, conducted research on \pglspl{db}~\cite{S1986TIPAOARDS}.
