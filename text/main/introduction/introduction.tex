...
For data that can be stored in a single table, simple text formats like \pgls{csv}~\cite{RFC4180} or \pgls{excel} tables~\cite{B2023DMWME,G2024ECRFMME} are common.
...
With the exception of \pgls{excel} tables, they are also text-based formats.\footnote{%
Today, \pgls{excel} tables are basically compressed collections of \pgls{xml} documents.%
} %
