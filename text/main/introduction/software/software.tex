...
\caption{A chart of a subset of the \pglspl{dbms} with which developers have worked, according to the StackOverflow Developer Surveys from 2017 to 2024~\cite{SE:SO:2024DS}. %
Not all of them are relational \pglspl{dbms}.}%
\label{fig:soDevSurv}%
\end{figure}%
%
A wide range of \pglspl{dbms} for \pglspl{rdb} exist.
The \begin{noglslink}\citetitle{RS2025DERORD}\end{noglslink}~\cite{RS2025DERORD} lists 166 products and in the \citetitle{SE:SO:2024DS}~\cite{SE:SO:2024DS}, programmers gave feedback on 25~\pglspl{dbms}.
...
%
\caption{The logos of several important open source softwares / \pglspl{dbms}.}%
...
Probably as the result of this, it ranked first in the \citetitle{SE:SO:2024DS} in the years 2017 to 2022.
...
In the \citetitle{SE:SO:2024DS}, it was the most popular \pgls{dbms}~\cite{SE:SO:2024DS}.
...
In June~2025, it ranked first as most popular \pgls{dbms} in~\cite{RS2025DERORD}.
...
It is an incredibly useful and convenient tool, which combines the features o a \pgls{rdb} with advanced form design and reporting features~\cite{SSI2023MA2BTA,B2020HOMA2,UC2021AFD,MM2014RDAMA}.
